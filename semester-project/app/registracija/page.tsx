...
const SignUp = () =>{
    ...
    const handleRegister = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            console.log("Korisnik je uspješno registriran.", userCredential.user);
        } catch (error) {
        alert("Greška prilikom registracije! Pokušajte ponovno.");
        }
    };
    ...
    return(
        <div className="flex items-center justify-center py-16 mx-5">
            ...
            <form onSubmit={handleRegister} className="bg-beige-200 rounded-2xl shadow-lg p-8 space-y-8">
                ...
                <div className="flex justify-center text-sm">
                    <p>Već imate račun? <a href="/prijava" className="font-semibold hover:underline transition">Prijavite se</a></p>
                </div>
